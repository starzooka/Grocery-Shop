...
function ShowProduct() {
    ...
    useEffect(() => {
        async function fetchProduct() {
            try {
                const response = await fetch(`https://grocery-shop-be.onrender.com:10000/products/fetchByName?name=${productName}`);
        ...
        async function fetchCartQuantity() {
            try {
                ...
                const response = await fetch(`https://grocery-shop-be.onrender.com:10000/cart/${userId}/${product.id}`);
    ...
    const handleAddItems = async () => {
        try {
            ...
            const response = await fetch('https://grocery-shop-be.onrender.com:10000/cart', {
                method: 'POST',
                headers: {
