...
export default function MyOrders() {
  ...
  const fetchOrders = async (userId) => {
    try {
      const response = await fetch(`https://grocery-shop-be.onrender.com:10000/order/${userId}`);
  ...
  const cancelOrder = async (orderId) => {
    ...
    if (cancelOrder) {
      try {
        const response = await fetch(`https://grocery-shop-be.onrender.com:10000/order/cancel`, {
          method: 'DELETE',
          headers: {
