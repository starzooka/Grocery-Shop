  ...
  useEffect(() => {
    async function fetchCartItems() {
      try {
        ...
        const response = await fetch(`https://grocery-shop-1.onrender.com:10000/cart/${userId}`);
  ...
  const handleOrder = async () => {
    ...
    if (confirmOrder) {
      try {
        ...
        const response = await fetch("https://grocery-shop-1.onrender.com:10000/order", {
          method: "POST",
          headers: {
        ...
        const del_response = await fetch(`https://grocery-shop-1.onrender.com:10000/cart/all`, {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
          },
